return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<C-t>", function() ui.nav_file(2) end, { desc = "Navigate to file 1" })
        vim.keymap.set("n", "<C-n>", function() ui.nav_file(3) end, { desc = "Navigate to file 1" })
        vim.keymap.set("n", "<C-s>", function() ui.nav_file(4) end, { desc = "Navigate to file 1" })
    end,
}
